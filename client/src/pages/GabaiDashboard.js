...
const HEB_NUMS = {1:'א׳',2:'ב׳',3:'ג׳',4:'ד׳',5:'ה׳',6:'ו׳',7:'ז׳',8:'ח׳',9:'ט׳',10:'י׳',11:'י"א',12:'י"ב',13:'י"ג',14:'י"ד',15:'ט"ו',16:'ט"ז',17:'י"ז',18:'י"ח',19:'י"ט',20:'כ׳',21:'כ"א',22:'כ"ב',23:'כ"ג',24:'כ"ד',25:'כ"ה',26:'כ"ו',27:'כ"ז',28:'כ"ח',29:'כ"ט',30:'ל׳'};
  ...
  return (
    <div className={styles.page}>
      <header className={styles.header}>
        <svg width="90" height="36" viewBox="0 0 200 80" xmlns="http://www.w3.org/2000/svg" style={{direction:"ltr"}} style={{flexShrink:0,marginLeft:6}}>
          ...
          <g transform="translate(100,32)"><polygon points="0,-18 15.5,9 -15.5,9" fill="none" stroke="url(#hgld)" strokeWidth="2.6" strokeLinejoin="round"/><polygon points="0,18 15.5,-9 -15.5,-9" fill="none" stroke="url(#hgld)" strokeWidth="2.6" strokeLinejoin="round"/></g>
          <text x="126" y="62" textAnchor="start" fontFamily="Heebo,sans-serif" fontSize="68" fontWeight="800" fill="url(#hgld)" letterSpacing="-2">AI</text>
        </svg>
        ...
        <div className={styles.headerBtns}>
          ...
          <button className={styles.iconBtn} onClick={() => navigate("/schedule")} title="לוח תפילות">🕐</button>
