  ...
  return (
    <div className={styles.page}>
      <header className={styles.header}>
        <svg width="90" height="36" viewBox="0 0 260 80" xmlns="http://www.w3.org/2000/svg" style={{direction:"ltr",flexShrink:0,marginLeft:6}}>
          ...
          <text x="160" y="62" textAnchor="start" fontFamily="Heebo,sans-serif" fontSize="68" fontWeight="800" fill="url(#hgld)" letterSpacing="-2">AI</text>
        </svg>
